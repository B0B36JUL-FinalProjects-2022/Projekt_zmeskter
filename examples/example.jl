...
scatter3d(cluster[51][:,1], cluster[51][:,2], cluster[51][:, 3],color = RGB(0,1,0), markersize = 1)
scatter3d!(cluster[2][:,1], cluster[2][:,2], cluster[2][:, 3],color = RGB(1,0,0), markersize = 1)
scatter3d!(cluster[3][:,1], cluster[3][:,2], cluster[3][:, 3],color = RGB(0,0,1), markersize = 1)
